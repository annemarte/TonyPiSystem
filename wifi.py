...
if __name__ == "__main__":
    ...
    def WIFI_MGR():
        ...
        if WIFI_MODE == 1: #AP
            ...
            while True:
                ...
                if wifi == WIFI_AP_SSID:
                    ...
                    return -1
                if timeout == 60:
                    print("*************Skippinng restart NetworkManager")
		...
		cmd = "nmcli -t -f DEVICE,STATE,CONNECTION dev | grep '^wlan0:connected'"
		...
		if not connected and count < WIFI_TIMEOUT:
                    count += 1
                    time.sleep(1)
                elif connected: #ssid_name == WIFI_STA_SSID:
		    ...
		    return -1
                    ...
                    msg = "Can not connect to SSID, trying again: " + WIFI_STA_SSID
                    print("*************%s"%msg)
		    time.sleep(2)
		    continue
                    #logger.error(msg)
